    ...
    for i in range(0,detections.shape[2]):
        ...
        if confidence > args['confidence']:
            ...
            if name and name != 'unknown':
                ...
                print(Hour+', '+name+'\n')
                print('==============================\n')
                print('Please put your finger to the modules\n')
                print('Waiting...')
                if server.Check_FIN(str(name)) == '1':
                    server.Login_status(str(name))
                    print('==============================')

                    print('Welcome to The Store, '+name)
                    break
                else:
                    print('False to Check,please try again')
                    break
